 ...
 * <p/>
 * VideoView also provide many wrapper methods for {@link io.vov.vitamio.MediaPlayer}, such as
 * {@link #getVideoWidth()}, {@link #setTimedTextShown(boolean)}
 */
public class VideoView extends SurfaceView implements MediaController.MediaPlayerControl
{
	...
	public void setVideoLayout(int layout, float aspectRatio)
	{
		...
		Log.d("VIDEO: %dx%dx%f, Surface: %dx%d, LP: %dx%d, Window: %dx%dx%f", mVideoWidth, mVideoHeight, mVideoAspectRatio, mSurfaceWidth, mSurfaceHeight,
