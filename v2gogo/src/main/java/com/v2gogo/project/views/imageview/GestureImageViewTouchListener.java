...
import com.v2gogo.project.views.imageview.animation.FlingAnimation;
import com.v2gogo.project.views.imageview.animation.FlingAnimationListener;
import com.v2gogo.project.views.imageview.animation.FlingListener;
import com.v2gogo.project.views.imageview.animation.MoveAnimation;
import com.v2gogo.project.views.imageview.animation.MoveAnimationListener;
import com.v2gogo.project.views.imageview.animation.ZoomAnimation;
import com.v2gogo.project.views.imageview.animation.ZoomAnimationListener;
...
public class GestureImageViewTouchListener implements OnTouchListener
{
	...
	private void startZoom(MotionEvent e)
	{
		...
		LogUtil.d("houjun", "zoomTo->" + zoomTo);
