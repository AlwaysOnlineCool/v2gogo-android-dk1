...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout
{
	...
	final class SmoothScrollRunnable implements Runnable
	{
		...
		public void run()
		{
			...
			/**
			 * Only set startTime if this is the first time we're starting, else actually calculate
			 * the Y delta
			 */
			if (startTime == -1)
			{
	...
	/**
	 * By default the Widget disabled scrolling on the Refreshable View while refreshing. This
	...
	private boolean pullEvent()
	{
		...
		if (DEBUG)
		{
			Log.e("hrx", "headerHeight:" + headerHeight + "  newHeight:" + newHeight);
		}
